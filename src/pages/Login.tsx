      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2 group">
            ...
            <span className="text-white text-2xl font-bold">NzrNest</span>
          </Link>
        </div>
        ...
        <Card className="bg-white/10 border-white/20 backdrop-blur-sm shadow-2xl">
          <CardHeader className="text-center space-y-2">
            ...
            <CardTitle className="text-2xl text-white">Sign In to NzrNest</CardTitle>
            <CardDescription className="text-gray-300">
              Access your AI-powered tools and continue your creative journey
            </CardDescription>
          </CardHeader>
